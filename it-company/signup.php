                ...
                <div class="row">
                    <div class="col-xs-4 col-xs-offset-4">
                        ...
                        <form method="post" action="user_registration_script.php">
                            ...
                            <div class="form-group">
                                <input type="password" class="form-control" name="password" placeholder="Пароль" required="true" pattern=".{6,}">
                            </div>
                            <div class="form-group"> 
                                <input type="tel" class="form-control" name="contact" placeholder="Номер" required="true">
                            </div>
                            <div class="form-group">
